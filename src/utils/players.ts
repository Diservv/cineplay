...
export const getMoviePlayers = (id: string | number, startAt?: number): PlayersProps[] => {
  return [
    {
      title: "SERVER1-BR",
      source: `https://superflixapi.best/filme/${id}?player=jw&primaryColor=f5a524&secondaryColor=a2a2a2&iconColor=eefdec&autoplay=true&startAt=${startAt || ""}`,
      fast: true,
      ads: true,
    },
    {
...
export const getTvShowPlayers = (
  ...
  return [
    {
      title: "SERVER1-BR",
      source: `https://superflixapi.best/serie/${id}/${season}/${episode}?player=jw&primaryColor=f5a524&secondaryColor=a2a2a2&iconColor=eefdec&autoplay=true&startAt=${startAt || ""}`,
      fast: true,
      ads: true,
    },
    {
